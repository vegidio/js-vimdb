...
describe('Scarlett Johansson is correctly scraped (EN)', () =>
{
    ...
    test('Know for "Encontros e Desencontros" and "The Avengers: Os Vingadores"', () => {
        expect(person.filmography.knownFor).toContainEqual({ identifier: 'tt0335266', name: 'Encontros e Desencontros' })
        expect(person.filmography.knownFor).toContainEqual({ identifier: 'tt0848228', name: 'The Avengers: Os Vingadores' })
    })
    ...
    test('Directed "American Express Unstaged: Ellie Goulding" and "These Vagabond Shoes"', () => {
        expect(person.filmography.director).toContainEqual({ identifier: 'tt5176560', name: 'American Express Unstaged: Ellie Goulding' })
