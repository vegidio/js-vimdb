...
describe('Chadwick Boseman is correctly scraped (EN)', () =>
{
    ...
    test('Know for "Black Panther" and "Captain America: Civil War"', () => {
        ...
        expect(person.filmography.knownFor).toContainEqual({ identifier: 'tt3498820', name: 'Captain America: Civil War' })
    })
    ...
    test('Directed "Heaven" and "Blood Over a Broken Pawn"', () => {
        ...
        expect(person.filmography.director).toContainEqual({ identifier: 'tt1370151', name: 'Blood Over a Broken Pawn' })
    })
})